...
tuple ResultadoTotalCost {
  float totalCost;
}

tuple ResultadoOccupancy {
  float occupancy;
}

tuple ResultadoMinOccupancy {
  float minOccupancy;
}

{ResultadoTotalCost} resultadoTotalCost = { <totalCost> };
{ResultadoOccupancy} resultadoOccupancy = { <occupancy> };
{ResultadoMinOccupancy} resultadoMinOccupancy = { <minOccupancy> };
